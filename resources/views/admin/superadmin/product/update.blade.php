              ...
              <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                  <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                      <div class="p-6 text-gray-900">
                          ...
                          <hr class="my-4" />
                          <form action="{{ route('admin/superadmin/products/update', $products->id) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              @method('PUT')
                              ...
                              <div class="form-group mb-4">
                                  ...
                                  <input type="number" name="modal" id="modal" class="form-control border border-gray-300 p-2 rounded w-full" placeholder="Modal" value="{{$products->modal}}">
                                  @error('modal')
                                  <span class="text-danger">{{$message}}</span>
                                  @enderror
                              </div>
                              <div class="form-group mb-4">
                                  ...
                                  <input type="number" name="feedropship" id="feedropship" class="form-control border border-gray-300 p-2 rounded w-full" placeholder="Feedropship" value="{{$products->feedropship}}">
                                  @error('feedropship')
                                  <span class="text-danger">{{$message}}</span>
                                  @enderror
                              </div>
                              <div class="form-group mb-4">
                                ...
                                <input type="number" name="feedokter" id="feedokter" class="form-control border border-gray-300 p-2 rounded w-full" placeholder="Feedokter" value="{{$products->feedokter}}">
                                @error('feedokter')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                              <div class="form-group mb-4">
                                  ...
                                  <input type="number" name="feeadmin" id="feeadmin" class="form-control border border-gray-300 p-2 rounded w-full" placeholder="Feeadmin" value="{{$products->feeadmin}}">
                                  @error('feeadmin')
                                  <span class="text-danger">{{$message}}</span>
                                  @enderror
                              </div>
                              <div class="form-group mb-4">
                                  ...
                                  <input type="number" name="laba" id="laba" class="form-control border border-gray-300 p-2 rounded w-full" placeholder="Laba" value="{{$products->laba}}">
                                  @error('laba')
                                  <span class="text-danger">{{$message}}</span>
                                  @enderror
                              </div>
                              <div class="form-group mb-4">
                                  ...
                                  <input type="number" name="feelayanan" id="feelayanan" class="form-control border border-gray-300 p-2 rounded w-full" placeholder="Feelayanan" value="{{$products->feelayanan}}">
                                  @error('feelayanan')
                                  <span class="text-danger">{{$message}}</span>
                                  @enderror
                              </div>
                              <div class="form-group mb-4">
                                  ...
                                  <input type="number" name="hargacoret" id="hargacoret" class="form-control border border-gray-300 p-2 rounded w-full" placeholder="Hargacoret" value="{{$products->hargacoret}}">
                                  @error('hargacoret')
                                  <span class="text-danger">{{$message}}</span>
                                  @enderror
                              </div>
